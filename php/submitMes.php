...
try{
        ...
        INSERT INTO `ed102g4`.`service` (`serFrom`, `serContent`, `serTime`, `memIP`, `admNo`) VALUES (0, :serContent, current_time(),$ip , '1');
        INSERT INTO `ed02g4`.`service` (`serFrom`, `serContent`, `serTime`, `memIP`, `admNo`) VALUES (1, :robContent, current_time(), $ip, '1');
